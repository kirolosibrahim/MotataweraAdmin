...
public class DoctorModel {
    ...
    public DoctorModel(String id, String name, String email, String password, int branch, boolean isDoctor, boolean isApproved, boolean isDisable, boolean isDeleted) {
        this.id = id;
        this.name = name;
        this.email = email;
